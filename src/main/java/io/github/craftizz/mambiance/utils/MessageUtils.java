...
public class MessageUtils {
    ...
    public static List<Component> parseMany(List<String> messages) {
        return messages.stream().map(MessageUtils::parse).collect(Collectors.toList());
    }
     ...
     * @return the parsed languages in component
     */
    public static List<Component> parseMany(List<String> messages, Map<String, String> placeholders) {
        return messages.stream().map(message -> miniMessage.parse(message, placeholders)).collect(Collectors.toList());
    }
